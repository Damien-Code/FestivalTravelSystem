<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('festivals.index')" :active="request()->routeIs('festival.index')">
                        {{ __('Festivals') }}
                    </x-nav-link>
                    <x-nav-link :href="route('vip.index')" :active="request()->routeIs('vip.index')">
                        {{ __('VIP') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('festivals.index')" :active="request()->routeIs('festival.index')">
                {{ __('Festivals') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('vip.index')" :active="request()->routeIs('vip.index')">
                {{ __('VIP') }}
            </x-responsive-nav-link>
