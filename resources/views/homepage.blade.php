    ...
    <section class="bg-white dark:bg-gray-900 pt-24">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <a href="{{route('festivals.index')}}" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Order here
            ...
            <div class="w-4/5 lg:w-full mt-6 lg:col-span-5 lg:flex mx-auto">
                <img src="{{ url('FTS.webp') }}" alt="FTS image">
            </div>
        </div>
    </section>
</x-app-layout>
