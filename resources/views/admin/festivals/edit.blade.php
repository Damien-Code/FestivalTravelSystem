...
{{--                               value="{{$festival->festivalInfo->description}}">--}}
...
{{--                </div>--}}
                <section class="w-1/2">
                    <div class="py-8 px-4 mx-auto max-w-3xl">
                        <h2 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">Update an existing festival</h2>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="description" rows="8"
                                              ...
                                              placeholder="Your description here" required> {{$festival->festivalInfo->description}} </textarea>
                                </div>
